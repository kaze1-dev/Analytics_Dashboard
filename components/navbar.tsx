...
import { HiCog, HiMenu } from 'react-icons/hi'
...
const Navbar = () => {
  ...
  return (
    <div>
      <div className='ml-3'>
        <nav className='bg-neutral-950 w-46 justify-between px-5 fixed top-3 bottom-3 flex-col py-5 font-sans rounded-2xl border border-neutral-800 hover:border-neutral-700 transition-all cursor-default hidden sm:hidden md:flex lg:flex xl:flex'>
        ...
        <div onClick={() => setIsMenuOpen(true)} className='fixed sm:fixed md:hidden lg:hidden xl:hidden top-7 z-50 left-5'>
          <button className='border border-neutral-800 bg-neutral-950 hover:border-neutral-700 transition-all  p-2 rounded-full cursor-pointer text-neutral-300'>
            <HiMenu
              size={22}
            />
          </button>
