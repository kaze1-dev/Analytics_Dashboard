  ...
  return (
    <div className='pl-55 pr-6 pb-10'>
      ...
      <div className='overflow-x-auto border border-neutral-800 px-6 rounded-2xl'>
        <table className='w-full left overflow-y-scroll'>
          <thead>
            <tr className='text-neutral-400 text-left border-b border-neutral-700'>
              <th className='pt-6 pb-4'>Customer Id</th>
              <th className='pt-6 pb-4'>Name</th>
              <th className='pt-6 pb-4'>Status</th>
              <th className='pt-6 pb-4'>Order count</th>
            </tr>
          </thead>
          <tbody>
            {
              customers.map((customer) => (
                ...
                >
                  ...
                  <td className='font-bold py-6 text-neutral-400'>{customer.status}</td>
